...
- Requires `--input-mode telonex-paired --read-from local|r2|local-or-download-from-r2-to-local` at backtest time.
...
- Requires `--input-mode telonex-delta --read-from local|r2|local-or-download-from-r2-to-local` at backtest time.
