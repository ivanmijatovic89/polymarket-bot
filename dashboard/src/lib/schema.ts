...
export const runtimeRuns = mysqlTable('runtime_runs', {
  ...
  // Owning machine (12-hex id from src/machines/identity.ts). Immutable;
  // commands for this run must go to this machine's daemon.
...
export const runtimeSessions = mysqlTable('runtime_sessions', {
  ...
  missionHash: varchar('mission_hash', { length: 64 }),
