...
export const definition: StrategyDefinition<Config> = {
  id: 'SplitSellRedeem.v5.1-research-metrics',
  title: 'Split + sell with dwell + time filters v5.1-research-metrics',
  description:
...
export function createStrategy(cfg: Config): {
  ...
  const name = 'SplitSellRedeem.v5.1-research-metrics'
