...
export const definition: StrategyDefinition<Config> = {
  id: 'SplitSellRedeem.v5.gate-netChange-and-ta-tf15mWickRatio',
  title: 'Split + sell with dwell + time filters v5.gate-netChange-and-ta-tf15mWickRatio',
  description:
    'A = (netChange_60s <= -0.24 OR netChange_60s >= 0.10 OR netChange_60s == 0.00) OR B = ta_tf15m_wickRatio <= 0.30027767043409165',
  schema: ConfigSchema,
...
export function createStrategy(cfg: Config): {
  ...
  const name = 'SplitSellRedeem.v5.gate-netChange-and-ta-tf15mWickRatio'
