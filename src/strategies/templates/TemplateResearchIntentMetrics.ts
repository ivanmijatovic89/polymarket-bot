...
export const definition: StrategyDefinition<Config> = {
  id: 'Template.ResearchIntentMetrics',
  title: 'Template: research intent metrics',
  description:
    'Template strategy that shows how to attach intent meta and persist it in backtests.',
  schema: ConfigSchema,
...
export function createStrategy(cfg: Config): {
  ...
  const name = 'Template.ResearchIntentMetrics'
