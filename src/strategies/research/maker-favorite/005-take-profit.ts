...
export const definition: StrategyDefinition<Config> = {
  id: 'maker-favorite.005-take-profit',
  title: 'Maker favorite take profit',
  description:
    'Places one delayed maker bid on a stronger favorite, then rests one maker take-profit sell for any filled position.',
  schema: ConfigSchema,
...
export function createStrategy(cfg: Config): { strategy: Strategy } {
  const name = 'maker-favorite.005-take-profit'
