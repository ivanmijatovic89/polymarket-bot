...
export const definition: StrategyDefinition<Config> = {
  id: 'maker-favorite.003-delayed-favorite',
  title: 'Maker favorite delayed entry',
  description:
    'Places one resting maker bid below mid on the favorite only after a fixed episode delay, then holds any fill to resolution.',
  schema: ConfigSchema,
...
export function createStrategy(cfg: Config): { strategy: Strategy } {
  const name = 'maker-favorite.003-delayed-favorite'
