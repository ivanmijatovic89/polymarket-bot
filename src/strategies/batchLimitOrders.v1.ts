...
export const definition: StrategyDefinition<Config> = {
  id: 'batchLimitOrders.v1',
  title: 'Batch limit orders v1',
  description:
    'Batch limit orders strategy: place limit orders for multiple assets at once.',
  schema: ConfigSchema,
...
export function createStrategy(cfg: Config): {
  ...
  const name = 'batchLimitOrders.v1'
