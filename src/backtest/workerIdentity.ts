...
// Canonical home is src/machines/identity.ts (shared with the machine
// catalog and, per issue #213, Global Runtime); re-exported here for
// existing importers.
export { getMachineId } from '../machines/identity.js'
