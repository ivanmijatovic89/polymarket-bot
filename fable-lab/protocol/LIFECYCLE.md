...
3. Write the strategy under `src/strategies/fable/<mechanism>/EXP-NNN.ts`
   (auto-discovered by the registry; id = `fable-exp-NNN`). The strategy
   must obey replay-safety rules (CAPABILITIES §3).
