...
| Work on worker deployment or self-update           | [Worker Self-Update](docs/backtest/worker-self-update.md)                                                                                                                                                                                  |
| Run workers across machines                        | [Distributed Workers](docs/backtest/distributed-future.md)                                                                                                                                                                                 |
