...
```bash
protocols/pair/scripts/setup-model-worktree.sh opus main pair-game-opus
```
...
npm run mission -- create \
  ...
  --journal-file protocols/pair-game-opus/state/JOURNAL.md \
  --inbox-file protocols/pair-game-opus/state/INBOX.md \
  --read-only protocols/pair-game-opus/RULES.md \
  --read-only protocols/pair-game-opus/LEVELS.md \
  --read-only protocols/pair-game-opus/state/PROPOSALS.md \
  --read-only protocols/pair-game-opus/state/CHAMPION.md \
