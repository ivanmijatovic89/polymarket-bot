 ...
 *   tsx protocols/pair-opus/tools/results.ts --run 857
 *   tsx protocols/pair-opus/tools/results.ts --run 856,857 --json
 *   tsx protocols/pair-opus/tools/results.ts --batch-uid smoke-20260730T194744-4vrhbh
 *   tsx protocols/pair-opus/tools/results.ts --label smoke --limit 10
 *   tsx protocols/pair-opus/tools/results.ts --last 5            # recent pair-opus runs
 *   tsx protocols/pair-opus/tools/results.ts --run 857 --markets # per-market rows
 *   tsx protocols/pair-opus/tools/results.ts --run 857 --segments daily
 *
...
try {
  ...
  else runs = await fetchRecentProtocolRuns(conn, 'pair-opus', o.last!)
